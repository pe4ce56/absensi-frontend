        ...
        <form onSubmit={handleSubmit}>
            <div className="form-group mb-3">
                <div className="input-group input-group-merge input-group-alternative">
                    ...
                    <input className="form-control" placeholder="NIP / Kode Guru / NISN" type="text" id="username" value={username} onChange={handleChange} />
                </div>
            ...
            <div className="form-group">
                <div className="input-group input-group-merge input-group-alternative">
                    ...
                    <input className="form-control" placeholder="Password" id="password" type="password" value={password} onChange={handleChange} />
                </div>
            </div>
